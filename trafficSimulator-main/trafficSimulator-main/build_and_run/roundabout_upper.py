...
class Intersection:
    def __init__(self):
        ...
        island_width = 2
        length = 100 #I have shortened the length of the entrance roads because vehicles base speeds are much lower because they are driving in a round about, however they would be able to drive faster in the entrance.
        radius = 18

        self.vehicle_rate = 30 # Increasing the vehicle rate 3 times default
        self.speed_variance = 2.5
        self.v = 11.33 # reduce the vehicle speed 1.5 times
